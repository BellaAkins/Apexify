...
const Footer = () => {
  return (
    <footer className="bg-gray-50">
      <div className="container mx-auto px-4 sm:px-4 lg:px-8 pt-16 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-4">
            <div className="flex gap-1 items-center mb-4">
              ...
              <span className="text-xl text-blue-600 font-medium ml-1">
                Apexify
              </span>
            </div>
            {/*paragraph*/}
        ...
        {/*bottom footer*/}
        <div className="border-t border-gray-200 mt-12 pt-8 flex flex-col md:flex-row">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-600 text-sm">
              Copyright © {new Date().getFullYear()} Bella.dev
            </p>
            <p className="text-600 text-sm">Created by SaraBella</p>
          </div>
        </div>
      </div>
    </footer>
